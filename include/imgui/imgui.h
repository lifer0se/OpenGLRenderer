...
namespace ImGui
{
    ...
    IMGUI_API bool          BulletTextColored(ImVec4& color, ImVec4& color_hovered, ImVec4& color_selected, bool* p_selected, const char* fmt, ...)            IM_FMTLIST(5);
    IMGUI_API bool          BulletTextColoredV(ImVec4& color, ImVec4& color_hovered, ImVec4& color_selected, bool selected, const char* fmt, va_list args)    IM_FMTLIST(5);
    ...
    IMGUI_API bool          ImageRadioButton(ImTextureID user_texture_id, const ImVec2& size, int* v, int v_button, const ImVec2& uv0 = ImVec2(0, 0),  const ImVec2& uv1 = ImVec2(1,1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0,0,0,0), const ImVec4& tint_col = ImVec4(1,1,1,1), const ImVec4& border_col = ImVec4(0.5,0.5,0.5,1), const ImVec4& border_col_active = ImVec4(1,1,1,1), const ImVec4& border_col_hovered = ImVec4(1,1,1,1), const float& unselected_dim = 0.5f);    // <0 frame_padding uses default frame padding settings. 0 for no padding
    IMGUI_API bool          ImageRadioCheckedButton(ImTextureID user_texture_id, const ImVec2& size, int* v, int v_button, int* c, const ImVec2& uv0 = ImVec2(0, 0),  const ImVec2& uv1 = ImVec2(1,1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0,0,0,0), const ImVec4& tint_col = ImVec4(1,1,1,1), const ImVec4& border_col = ImVec4(0.5,0.5,0.5,1), const ImVec4& border_col_active = ImVec4(1,1,1,1), const ImVec4& border_col_hovered = ImVec4(1,1,1,1), const ImVec4& border_col_checked = ImVec4(1,1,1,1));    // <0 frame_padding uses default frame padding settings. 0 for no padding
